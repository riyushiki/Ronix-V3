...
function savitzkyGolay(data, h, options) {
  ...
  if (
    ...
    let J = mlMatrix.Matrix.ones(options.windowSize, options.polynomial + 1);
    ...
    let Jtranspose = new mlMatrix.MatrixTransposeView(J);
    let Jinv = mlMatrix.inverse(Jtranspose.mmul(J));
